    ...
    fn process(
        ...
        let mut pm_matrix = [
            f32x8::from([
                ...
                self.params.mod_osc2_by_osc7.value(),
                self.params.mod_osc2_by_osc8.value(),
            ]),
            f32x8::from([
                ...
                self.params.mod_osc3_by_osc7.value(),
                self.params.mod_osc3_by_osc8.value(),
            ]),
            f32x8::from([
                ...
                self.params.mod_osc4_by_osc8.value(),
            ]),
            f32x8::from([
            ...
            f32x8::from([
                self.params.mod_osc7_by_osc1.value(),
                self.params.mod_osc7_by_osc2.value(),
                self.params.mod_osc7_by_osc3.value(),
            ...
            f32x8::from([
                self.params.mod_osc8_by_osc1.value(),
                self.params.mod_osc8_by_osc2.value(),
                self.params.mod_osc8_by_osc3.value(),
                self.params.mod_osc8_by_osc4.value(),
